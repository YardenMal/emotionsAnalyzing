...
class NewApp(MDApp):
    ...
    def selected(self, selection):
        if selection:
            # self.strng.get_screen('mainscreen').ids.wavFile.text = selection[0]
            ...
            if self.wavFile:
                ...
                #show the result !
                print(self.wavFile, result)

    def play_sound(self):
        sound = "C:\\Users\\USER\\Desktop\\RAVDESS\\Actor_01\\03-01-02-02-02-01-01.wav"
        print(type(sound))
        if sound:
            model = pickle.load(open("GB_classifier.model", "rb"))
